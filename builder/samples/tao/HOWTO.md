...
```bash
docker pull nvcr.io/nvstaging/deepstream/deepstream:9.1.0-triton-multiarch-26.06.1.1
docker create --name temp nvcr.io/nvstaging/deepstream/deepstream:9.1.0-triton-multiarch-26.06.1.1
