...
```bash
docker pull nvcr.io/nvidia/deepstream:deepstream:9.0-triton-multiarch
docker create --name temp nvcr.io/nvidia/deepstream:deepstream:9.0-triton-multiarch
