...
cd builder
python main.py --server-type triton samples/changenet/trt_changenet.yaml -a samples/changenet/openapi.yaml -c samples/changenet/processors.py -o samples/changenet -t
